 ...
 * Source: /Users/kilic/Dev/universal-commerce-protocol/ucp/spec/schemas/shopping/types/fulfillment_destination_resp.json
 * Schema ID: https://ucp.dev/schemas/shopping/types/fulfillment_destination.json
 *
 * DO NOT EDIT MANUALLY - This file is auto-generated
 * To update: Run `bun run schemas:generate` from ucp-doctor root
 *
 * Generated: 2026-01-16T11:38:45.525Z
 */
 ...
 */
export const FulfillmentDestinationRespSchema = z.record(z.any()).and(z.any().superRefine((x, ctx) => {
...
export type FulfillmentDestinationRespSchema = z.infer<typeof FulfillmentDestinationRespSchema>
