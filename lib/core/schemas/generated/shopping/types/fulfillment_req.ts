 ...
 * Source: /Users/kilic/Dev/universal-commerce-protocol/ucp/spec/schemas/shopping/types/fulfillment_req.json
 * Schema ID: https://ucp.dev/schemas/shopping/types/fulfillment_req.json
 *
 * DO NOT EDIT MANUALLY - This file is auto-generated
 * To update: Run `bun run schemas:generate` from ucp-doctor root
 *
 * Generated: 2026-01-16T11:38:45.532Z
 */
 ...
 */
export const FulfillmentReqSchema = z.object({ "methods": z.array(z.object({ "type": z.enum(["shipping","pickup"]).describe("Fulfillment method type."), "line_item_ids": z.array(z.string()).describe("Line item IDs fulfilled via this method.").optional(), "destinations": z.array(z.record(z.any()).and(z.any().superRefine((x, ctx) => {
