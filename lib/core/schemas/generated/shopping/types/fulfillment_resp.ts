 ...
 * Source: /Users/kilic/Dev/universal-commerce-protocol/ucp/spec/schemas/shopping/types/fulfillment_resp.json
 * Schema ID: https://ucp.dev/schemas/shopping/types/fulfillment.json
 *
 ...
 */
export const FulfillmentRespSchema = z.object({ "methods": z.array(z.object({ "id": z.string().describe("Unique fulfillment method identifier."), "type": z.enum(["shipping","pickup"]).describe("Fulfillment method type."), "line_item_ids": z.array(z.string()).describe("Line item IDs fulfilled via this method."), "destinations": z.array(z.record(z.any()).and(z.any().superRefine((x, ctx) => {
